...
const formatIDForCSV = (id) => {
  ...
  `${obj.rest_name}|${obj.tags.join(',')}|${obj.state}|${obj.website}|${obj.zip}\n`;
}
...
const overviewStreamID = fs.createWriteStream('../csv/cass/overviewStreamID.csv');
